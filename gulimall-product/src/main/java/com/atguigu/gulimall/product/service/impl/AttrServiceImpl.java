...
public class AttrServiceImpl extends ServiceImpl<AttrDao, AttrEntity> implements AttrService {
    ...
    public void saveAttr(AttrVo attr) {
        ...
        //2.保存关联关系
        if (attr.getAttrGroupId() == ProductConstant.AttrEnum.ATTR_TYPE_BASE.getCode() && attr.getAttrGroupId() != null){
...
//        relationDao.delete(new QueryWrapper<>().eq("attr_id", 1L).eq("attr_group_id", 1L));
        ...
        relationDao.deleteBatchRelatioins(entities);
    }
    ...
    public PageUtils getNoRelationAttr(Map<String, Object> params, Long attrgroupId) {
        ...
        if (!StringUtils.isEmpty(key)){
            wrapper.and((w)->{
                QueryWrapper<AttrEntity> page = w.eq("attr_id", key).or().like("attr_name", key);
            });
        }
